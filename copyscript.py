...
def moch_yayan():
    ...
    print '___________________________________________________________'
    print '\n [%s1%s]. Dump id of friends'%(O,N)
    print ' [%s2%s]. Dump id of public friend'%(O,N)
    print ' [%s3%s]. Dump id of total followers'%(O,N)
    print ' [%s4%s]. Dump id from like post'%(O,N)
...
# The one who replaces the bot, I swear, your mother will die too!
